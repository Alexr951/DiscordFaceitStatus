...
class DiscordRPC:
    ...
    def update_live(
        ...
        Args:
            ...
            region: Region label for the rank, e.g. "EU" (None to omit)
            show_map: Whether to show map name
            show_avg_elo: Whether to show average ELO
        ...
        # Build state line: "K/D/A: 15/8/3 | NA Rank #6,264 | Avg ELO: 2150"
        # (no flag emoji: Windows renders country flags as plain letters)
        state_parts = []
